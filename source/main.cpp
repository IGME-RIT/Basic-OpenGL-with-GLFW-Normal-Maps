...
int main(int argc, char **argv)
{
	...
	// Initialize window
	GLFWwindow* window = glfwCreateWindow(viewportDimensions.x, viewportDimensions.y, "Bumpy", nullptr, nullptr);
    ...
    material->SetTexture("tex", new Texture("../assets/iron_buckler_diffuse.png"));
    material->SetTexture("tex2", new Texture("../assets/iron_buckler_normal.png"));
